...
// {
//     [SerializeField] InputField inputJoinRoomName;
...
//              inputJoinRoomName.characterLimit = 5;
//              inputFindRoomName.characterLimit = 5;
...
//     {
//         string searchText = GetFindRoomName();
...
//         string roomName = GetJoinRoomName();
//         string playerName = GetPlayerName();
//         if(roomName.Length > 0 && playerName.Length > 0){
...
//     {
//         string roomName = GetFindRoomName();
